...
## Code Demonstration {auto-animate="true" visibility="uncounted"}
...
# priors/initial proposals
βprop = makeProposal(Gamma(8, 0.025), :β)
σprop = makeProposal(Gamma(8, 0.025), :σ)
γprop = makeProposal(Gamma(8, 0.0125), :γ)
