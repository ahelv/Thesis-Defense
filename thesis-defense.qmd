...
The goal of a particle filter is to recursively estimate the posterior, $p(x_t | y_{1:t})$ using Bayes' theorem:

$$p(x_t | y_{1:t}) = \frac{p(y_t | x_t) p(x_t | y_{1:t-1})}{\int p(y_t | x_t) p(x_t | y_{1:t-1})dx_t}$$

. . . 

However, this can rarely be done analytically so an approximation is required. 

- Use importance sampling to approximate the continuous pdf with a weighted sum of $N_s$ potential realizations of the true state: $p(x_{0:t}| y_{1:t}) \approx \sum_{i=1}^{N_s} w_{t}^{i} \delta (x_{0:t} - x_{0:t}^i)$

## Particle Filters Cont. {visibility="hidden"}

Particle filter approximation: $p(x_{0:t}| y_{1:t}) \approx \sum_{i=1}^{N_s} w_{t}^{i} \delta (x_{0:t} - x_{0:t}^i)$

- The set $\{ w_t^i, x_{0:t}^i\}_i^{N_s}$ contains $N_s$ samples, $x_{0:t}^i$ and their weights $w_t^i$.
...
- Assumes $x_{t:1}$ is a Markov chain
...
![](nested-alg.png){width="700" height="700"}
...
![Nested Particle Filter](./nested/Iest_n1l.png){#fig-nested-I width=50%}

![Hybrid Particle Filter](/hybrid/Iest_h1l.png){#fig-hybrid-I width=50%}
...
![Nested Particle Filter](/nested/betaEst_n1l.png){#fig-nested-beta width=50%}

![Hybrid Particle Filter](/hybrid/betaEst_h1l.png){#fig-hybrid-beta width=50%}
...
![Nested Particle Filter](/nested/sigmaEst_n1l.png){#fig-nested-sigma width=50%}

![Hybrid Particle Filter](/hybrid/sigmaEst_h1l.png){#fig-hybrid-sigma width=50%}
...
![Nested Particle Filter](/nested/gammaEst_n1l.png){#fig-nested-gamma width=50%}

![Hybrid Particle Filter](/hybrid/gammaEst_h1l.png){#fig-hybrid-gamma width=50%}
...
![Nested Particle Filter](/nested/Unif_Iest_n1l.png){#fig-nested-I-unif width=50%}

![Hybrid Particle Filter](/hybrid/Unif_Iest_h1l.png){#fig-hybrid-I-unif width=50%}
...
![Nested Particle Filter](/nested/Unif_betaEst_n1l.png){#fig-nested-beta-unif width=50%}

![Hybrid Particle Filter](/hybrid/Unif_betaEst_h1l.png){#fig-hybrid-beta-unif width=50%}
...
![Nested Particle Filter](/nested/Unif_sigmaEst_n1l.png){#fig-nested-sigma-unif width=50%}

![Hybrid Particle Filter](/hybrid/Unif_sigmaEst_h1l.png){#fig-hybrid-sigma-unif width=50%}
...
![Nested Particle Filter](/nested/Unif_gammaEst_n1l.png){#fig-nested-gamma-unif width=50%}

![Hybrid Particle Filter](/hybrid/Unif_gammaEst_h1l.png){#fig-hybrid-gamma-unif width=50%}
...
![Nested Particle Filter](/nested/gam8_Iest_n1l.png){#fig-nested-I-gam width=50%}

![Hybrid Particle Filter](/hybrid/gam8_Iest_h1l.png){#fig-hybrid-I-gam width=50%}
...
![Nested Particle Filter](/nested/gam8_betaEst_n1l.png){#fig-nested-beta-gam width=50%}

![Hybrid Particle Filter](/hybrid/gam8_betaEst_h1l.png){#fig-hybrid-beta-gam width=50%}
...
![Nested Particle Filter](/nested/gam8_sigmaEst_n1l.png){#fig-nested-sigma-gam width=50%}

![Hybrid Particle Filter](/hybrid/gam8_sigmaEst_h1l.png){#fig-hybrid-sigma-gam width=50%}
...
![Nested Particle Filter](/nested/gam8_gammaEst_n1l.png){#fig-nested-gamma-gam width=50%}

![Hybrid Particle Filter](/hybrid/gam8_gammaEst_h1l.png){#fig-hybrid-gamma-gam width=50%}
...
![](MSE_1loc.png){width="600" height="850"}
...
- We compared the time required to conduct esttimation (clock time) with the Hybrid and Nested Particle Filters as well as an MCMC approach.
...
- Any compartmental model structure can be specific. 
